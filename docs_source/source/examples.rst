...
.. automodule:: examples.circle
.. autofunction:: examples.circle.main

examples.duffing
-------------------------------------------

.. automodule:: examples.duffing
    :members:
...
.. automodule:: examples.vanderpol_animation
    :members:
...
.. automodule:: examples.convergence.demo_mathieu_N_convergence
    :members: analyze_N_mathieu, analyze_smoothness_effects

examples.convergence.demo_meissner_aliasing
****************************************************

.. automodule:: examples.convergence.demo_meissner_aliasing
